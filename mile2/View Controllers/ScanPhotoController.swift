//
//  ScanPhotoController.swift
//  mile2
//
//  Created by Kirito24K Shi on 2021-03-17.
//
...
class ScanPhotoController: UIViewController, UINavigationControllerDelegate {
    
    @IBOutlet weak var photoImageView: UIImageView?
    
    lazy var detectionRequest: VNCoreMLRequest = {
        do {
            let model = try VNCoreMLModel(for: dog_breeds_2.1().model)
...
extension ScanPhotoController: UIImagePickerControllerDelegate {
